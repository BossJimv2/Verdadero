                    ...
                    <div class="p-6">
                        ...
                        <form method="POST" action="{{ isset($user) ? route('user.update', $user->id) : route('users.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="mt-4">
                                ...
                                <input id="profile" type="file" name="profile" accept="image/*" class="block mt-1 w-full bg-[#1c2a3a] text-black" onchange="previewImage(event)">
                            ...
                            <div class="mt-4">
                                ...
                                <input id="name" type="text" name="name" value="{{ old('name', $user->name ?? '') }}" class="block mt-1 w-full bg-[#1c2a3a] text-black">
                            ...
                            <div class="mt-4">
                                ...
                                <input id="password" type="password" name="password" class="block mt-1 w-full bg-[#1c2a3a] text-black">
                            ...
                            <div class="mt-4">
                                ...
                                <input id="password_confirmation" type="password" name="password_confirmation" class="block mt-1 w-full bg-[#1c2a3a] text-black">
                            </div>
